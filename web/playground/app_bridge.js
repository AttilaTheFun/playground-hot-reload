...
import { BlobReader, BlobWriter, Runtime, SwiftError, Tags, Types, decodeWith, decoder, encodeError, encodeErrorBlob, encodeWith, errorMessageOf, foreignObjects, nextCallId, pendingCalls, registerForeign, registry, resumeAsync, stageBytes, stageString, takeBytes, wasiShim, } from "./swift_ffi_runtime.js?v=3623859961";
// Re-exported so consumers keep importing them from this module.
export { Types } from "./swift_ffi_runtime.js?v=3623859961";
...
export const PlaygroundHostKeyType = {
    encode(w, v) {
        Types.string.encode(w, v);
    },
    decode(r) {
...
export class SwiftPlaygroundHostService {
    handle;
    runtime;
    /** @internal Takes ownership of a +1 handle. */
    constructor(runtime, handle) {
        this.runtime = runtime;
        this.handle = handle;
        registry.register(this, () => runtime.call("swift_ffi_playground_web_PlaygroundHostService_release", handle), this);
    }
    /** @internal */
    borrowHandle() {
        if (this.handle === 0)
            throw new Error("PlaygroundHostService used after close()");
        return this.handle;
    }
    /** Releases the underlying Swift instance. Idempotent. */
    close() {
        if (this.handle !== 0) {
            registry.unregister(this);
            this.runtime.call("swift_ffi_playground_web_PlaygroundHostService_release", this.handle);
            this.handle = 0;
        }
    }
    [Symbol.dispose]() {
    ...
    compile(source) {
        ...
        const staged = stageBytes(this.runtime, w.data());
        const box = this.runtime.call("swift_ffi_playground_web_PlaygroundHostService_invoke", handle, 0, staged.ptr, staged.len);
        staged.drop();
        const result = takeBytes(this.runtime, box);
        const failure = errorMessageOf(result);
        if (failure !== null)
    ...
    run() {
        ...
        const staged = stageBytes(this.runtime, w.data());
        const box = this.runtime.call("swift_ffi_playground_web_PlaygroundHostService_invoke", handle, 1, staged.ptr, staged.len);
        staged.drop();
        const result = takeBytes(this.runtime, box);
        const failure = errorMessageOf(result);
        if (failure !== null)
    ...
    stop() {
        ...
        const w = new BlobWriter();
        const staged = stageBytes(this.runtime, w.data());
        const box = this.runtime.call("swift_ffi_playground_web_PlaygroundHostService_invoke", handle, 2, staged.ptr, staged.len);
        staged.drop();
        const result = takeBytes(this.runtime, box);
        const failure = errorMessageOf(result);
        if (failure !== null)
    ...
    swipe(target, dx, dy) {
        ...
        Types.int32.encode(w, callId);
        Types.string.encode(w, target);
        Types.double.encode(w, dx);
        Types.double.encode(w, dy);
        const promise = new Promise((resolve, reject) => {
            pendingCalls.set(callId, {
                resolve: resolve,
                decode: (blob) => {
...
/** Wraps a consumer-implemented `PlaygroundHostService` as the ordinal
 * dispatcher Swift's foreign proxy calls (method ordinal leads the
 * arguments). */
export function makeDispatcher_PlaygroundHostService(impl, runtime) {
    return (args) => {
        const r = new BlobReader(args);
        switch (Types.int32.decode(r)) {
            case 0: {
                ...
                const a0 = Types.string.decode(r);
                if (!runtime)
                    throw new SwiftError("PlaygroundHostService.compile is async and needs a runtime-bound dispatcher");
                const rt = runtime;
                Promise.resolve().then(() => impl.compile(a0)).then((value) => resumeAsync(rt(), callId, encodeWith(Types.string, value)), (error) => resumeAsync(rt(), callId, encodeError(error instanceof Error ? error.message : String(error))));
                return new Uint8Array(0);
            }
            case 1: {
                const callId = Types.int32.decode(r);
                if (!runtime)
                    throw new SwiftError("PlaygroundHostService.run is async and needs a runtime-bound dispatcher");
                const rt = runtime;
                Promise.resolve().then(() => impl.run()).then((value) => resumeAsync(rt(), callId, encodeWith(Types.string, value)), (error) => resumeAsync(rt(), callId, encodeError(error instanceof Error ? error.message : String(error))));
                return new Uint8Array(0);
            }
            case 2: {
                impl.stop();
            ...
            case 4: {
                ...
                const a0 = Types.string.decode(r);
                if (!runtime)
                    throw new SwiftError("PlaygroundHostService.chat is async and needs a runtime-bound dispatcher");
                const rt = runtime;
            ...
            case 10: {
                ...
                const a0 = Types.string.decode(r);
                if (!runtime)
                    throw new SwiftError("PlaygroundHostService.tap is async and needs a runtime-bound dispatcher");
                const rt = runtime;
            ...
            case 11: {
                ...
                const a1 = Types.string.decode(r);
                if (!runtime)
                    throw new SwiftError("PlaygroundHostService.typeText is async and needs a runtime-bound dispatcher");
                const rt = runtime;
            ...
            case 12: {
                ...
                const a0 = Types.string.decode(r);
                if (!runtime)
                    throw new SwiftError("PlaygroundHostService.submit is async and needs a runtime-bound dispatcher");
                const rt = runtime;
            ...
            case 13: {
                ...
                const a2 = Types.double.decode(r);
                if (!runtime)
                    throw new SwiftError("PlaygroundHostService.swipe is async and needs a runtime-bound dispatcher");
                const rt = runtime;
                Promise.resolve().then(() => impl.swipe(a0, a1, a2)).then((value) => resumeAsync(rt(), callId, encodeWith(Types.string, value)), (error) => resumeAsync(rt(), callId, encodeError(error instanceof Error ? error.message : String(error))));
                return new Uint8Array(0);
            }
        }
        throw new SwiftError("unknown PlaygroundHostService method ordinal");
    };
}
...
export const Dependencies = {
    ...
    playgroundHostService: (provide, lazy = true) => {
        let impl;
        return {
            key: "swift_ffi_playground_web_PlaygroundHostService",
            lazy,
            dispatcher: (args, runtime) => {
                if (!impl)
                    impl = provide();
                return makeDispatcher_PlaygroundHostService(impl, runtime)(args);
            },
        };
    },
};
