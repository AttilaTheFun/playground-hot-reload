...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3623859961");
//   <UniversalUI wasmURL="./app.wasm?v=3623859961" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3623859961", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3623859961";
import { packagedBundleProvider } from "./bundle_provider.js?v=3623859961";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3623859961", renderer = "react", style }) {
