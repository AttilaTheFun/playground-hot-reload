...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=2025723080");
//   <UniversalUI wasmURL="./app.wasm?v=2025723080" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=2025723080", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=2025723080";
import { packagedBundleProvider } from "./bundle_provider.js?v=2025723080";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=2025723080", renderer = "react", style }) {
