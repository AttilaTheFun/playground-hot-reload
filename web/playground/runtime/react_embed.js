...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=4262951312");
//   <UniversalUI wasmURL="./app.wasm?v=4262951312" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=4262951312", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=4262951312";
import { packagedBundleProvider } from "./bundle_provider.js?v=4262951312";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=4262951312", renderer = "react", style }) {
