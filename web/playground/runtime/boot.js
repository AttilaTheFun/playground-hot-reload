...
import { load } from "../app_bridge.js?v=2025723080";
import { createRasterHost } from "./raster.js?v=2025723080";
import { createReactTreeRenderer } from "./react_renderer.js?v=2025723080";
import { applyPatch } from "./flat_tree.js?v=2025723080";
...
export async function boot({
  ...
  if (!react) {
    ...
    const { createSwiftGPUHost } = await import("./swift_gpu_webgpu.js?v=2025723080");
...
export async function mountUniversalUI(container, { wasmURL, bundle, renderer = "webGPU", dependencies = {}, wasi = undefined } = {}) {
  ...
  const result = await boot({
    canvas, wasmURL: bundle ? undefined : (wasmURL || "./app.wasm?v=2025723080"),
