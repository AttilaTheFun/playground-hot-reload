...
import { load } from "../app_bridge.js?v=4262951312";
import { createRasterHost } from "./raster.js?v=4262951312";
import { createReactTreeRenderer } from "./react_renderer.js?v=4262951312";
import { applyPatch } from "./flat_tree.js?v=4262951312";
...
export async function boot({
  ...
  if (!react) {
    ...
    const { createSwiftGPUHost } = await import("./swift_gpu_webgpu.js?v=4262951312");
...
export async function mountUniversalUI(container, { wasmURL, bundle, renderer = "webGPU", dependencies = {}, wasi = undefined } = {}) {
  ...
  const result = await boot({
    canvas, wasmURL: bundle ? undefined : (wasmURL || "./app.wasm?v=4262951312"),
