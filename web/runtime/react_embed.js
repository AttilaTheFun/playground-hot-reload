...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=374920138");
//   <UniversalUI wasmURL="./app.wasm?v=374920138" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=374920138", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=374920138";
import { packagedBundleProvider } from "./bundle_provider.js?v=374920138";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=374920138", renderer = "react", style }) {
