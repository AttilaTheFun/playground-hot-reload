...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3004500245");
//   <UniversalUI wasmURL="./app.wasm?v=3004500245" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3004500245", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3004500245";
import { packagedBundleProvider } from "./bundle_provider.js?v=3004500245";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3004500245", renderer = "react", style }) {
