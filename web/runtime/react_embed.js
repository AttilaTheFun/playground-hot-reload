...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=2821634064");
//   <UniversalUI wasmURL="./app.wasm?v=2821634064" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=2821634064", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=2821634064";
import { packagedBundleProvider } from "./bundle_provider.js?v=2821634064";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=2821634064", renderer = "react", style }) {
