...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=1337352472");
//   <UniversalUI wasmURL="./app.wasm?v=1337352472" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=1337352472", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=1337352472";
import { packagedBundleProvider } from "./bundle_provider.js?v=1337352472";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=1337352472", renderer = "react", style }) {
