...
import { load } from "../app_bridge.js?v=374920138";
import { createRasterHost } from "./raster.js?v=374920138";
import { createReactTreeRenderer } from "./react_renderer.js?v=374920138";
import { applyPatch } from "./flat_tree.js?v=374920138";
...
export async function boot({
  ...
  if (!react) {
    ...
    const { createSwiftGPUHost } = await import("./swift_gpu_webgpu.js?v=374920138");
...
export async function mountUniversalUI(container, { wasmURL, bundle, renderer = "webGPU", dependencies = {}, wasi = undefined } = {}) {
  ...
  const result = await boot({
    canvas, wasmURL: bundle ? undefined : (wasmURL || "./app.wasm?v=374920138"),
