...
import { BlobWriter, Runtime, Tags, Types, decoder as ffiDecoder, encodeErrorBlob, foreignObjects, pendingCalls, registerForeign, wasiShim } from "./swift_ffi_runtime.js?v=1337352472";
import { createReactTreeRenderer } from "./runtime/react_renderer.js?v=1337352472";
import { applyPatch } from "./runtime/flat_tree.js?v=1337352472";
