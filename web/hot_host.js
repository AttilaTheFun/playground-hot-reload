...
import { BlobWriter, Runtime, Tags, Types, decoder as ffiDecoder, encodeErrorBlob, foreignObjects, pendingCalls, registerForeign, wasiShim } from "./swift_ffi_runtime.js?v=3004500245";
import { createReactTreeRenderer } from "./runtime/react_renderer.js?v=3004500245";
import { applyPatch } from "./runtime/flat_tree.js?v=3004500245";
